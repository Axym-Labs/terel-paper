...
\providecommand{\LeadFigureMaxHeight}{0.29\textheight}
\providecommand{\LeadFigureCaption}{%
\textbf{Left:} Spectral projection of TeReL validation
...
\input{appendix/trace_learning_derivation.tex}
...
\input{appendix/hyperparameter_guidance.tex}

\input{appendix/rnn_details.tex}

\input{appendix/ablation_results.tex}
